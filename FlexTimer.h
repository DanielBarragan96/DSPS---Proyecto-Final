...
/*!
 	 \brief
 	 	 Initialices the flextimer 2 into input capture mode
 	 \return void
...
/*!
 	 \brief
 	 	 Interrupt status register of the flex timer 2.
 	 \return void
...
/*!
 	 \brief
 	 	 Using the period cnv and mod values of the edges to get the frequency calculation.
 	 \return void
...
/*!
 	 \brief
 	 	 Intitialices the flextimer for the pwm.
 	 \return void
