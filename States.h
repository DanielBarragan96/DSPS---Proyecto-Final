...
/********************************************************************************************/
/*!
 	 \brief	 This function handles the input of the PADS, from the interruption
 	 \return TRUE if there were no troubles
 */
...
/********************************************************************************************/
/*!
 	 \brief	 This function handles the input of the PADS, from the main excecution
 	 \return TRUE if there were no troubles
 */
...
/********************************************************************************************/
/*!
 	 \brief	 This function returns the direction of the padsInput variable.
 	 \return currentSystem direction
 */
